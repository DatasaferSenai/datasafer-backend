...
import datasafer.backup.bo.validator.Validador;
...
public class BackupBo {
	...
	public void modificar(String login_solicitante, String login_proprietario, String nome_estacao, String nome_backup, Backup backup)
			throws DataRetrievalFailureException, DataIntegrityViolationException {
		...
		Backup backup_existente = backupDao.obter(login_proprietario, nome_estacao, nome_backup);
		if (backup_existente == null) {
			throw new DataRetrievalFailureException("Backup não encontrado.");
		}

		Validador.validar(backup);

		backupDao.modificar(login_solicitante, backup_existente);
	}
	...
	public void excluir(String login_solicitante, String login_proprietario, String nome_estacao, String nome_backup)
			throws DataRetrievalFailureException, DataIntegrityViolationException {
