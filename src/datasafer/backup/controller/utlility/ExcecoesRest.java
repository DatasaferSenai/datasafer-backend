...
public class ExcecoesRest extends ResponseEntityExceptionHandler {
	...
	protected ResponseEntity<Object> handleHttpRequestMethodNotSupported(	final HttpRequestMethodNotSupportedException ex,
		...
		return new ResponseEntity<>(responde, headers, HttpStatus.METHOD_NOT_ALLOWED);
	}

	@ExceptionHandler(value = { ConstraintViolationException.class })
	protected ResponseEntity<Object> respondeErro(	final ConstraintViolationException ex,
													final WebRequest request) {
	...
	protected ResponseEntity<Object> respondeErro(	final DataIntegrityViolationException ex,
													final WebRequest request) {
	...
	protected ResponseEntity<Object> respondeAcessoNegado(	final AccessDeniedException ex,
															final WebRequest request) {
