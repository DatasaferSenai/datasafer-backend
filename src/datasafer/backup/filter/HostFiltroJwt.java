	...
	public void doFilter(ServletRequest req, ServletResponse resp, FilterChain chain)
		...
		if (!privilegio.getPermissoes().contains(Privilegio.Permissao.ADMINISTRADOR)) {
			if ((request.getMethod() == "GET"
					&& !privilegio.getPermissoes().contains(Privilegio.Permissao.VISUALIZAR_HOSTS))
					| (request.getMethod() == "POST"
							&& !privilegio.getPermissoes().contains(Privilegio.Permissao.INSERIR_HOSTS))
					| (request.getMethod() == "UPDATE"
							&& !privilegio.getPermissoes().contains(Privilegio.Permissao.MODIFICAR_HOSTS))
					| (request.getMethod() == "DELETE"
							&& !privilegio.getPermissoes().contains(Privilegio.Permissao.EXCLUIR_HOSTS))
